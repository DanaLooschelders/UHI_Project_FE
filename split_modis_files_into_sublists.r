...
path=terrapath
    ...
    ###check ?bereinstimmung
      ...
      filelist_data_night <- filelist_data[lapply(strsplit(filelist_data,"_"),function(x){x[[7]]})=="Night"]
      filelist_data_day <- filelist_data[lapply(strsplit(filelist_data,"_"),function(x){x[[7]]})=="Day"]
      ...
      filelist_data_night <- filelist_data_night[lapply(strsplit(filelist_data_night,"_"),function(x){x[[7]]})%in%
                                                   lapply(strsplit(filelist_time_night,"_"),function(x){x[[8]]})]
      filelist_time_night <- filelist_time_night[lapply(strsplit(filelist_time_night,"_"),function(x){x[[7]]})%in%
                                                   lapply(strsplit(filelist_data_night,"_"),function(x){x[[7]]})]
      filelist_data_day <- filelist_data_day[lapply(strsplit(filelist_data_day,"_"),function(x){x[[7]]})%in%
                                               lapply(strsplit(filelist_time_day,"_"),function(x){x[[8]]})]
      filelist_time_day <- filelist_time_day[lapply(strsplit(filelist_time_day,"_"),function(x){x[[8]]})%in%
                                               lapply(strsplit(filelist_data_day,"_"),function(x){x[[7]]})]
